    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="w-4/6 flex flex-col justify-self-center mx-auto max-sm:w-11/12 h-[88%]">
                <h1 className="text-lg"><b>Datenschutz&shy;erkl&auml;rung</b></h1>
                <h2 className="mt-2"><b>1. Datenschutz auf einen Blick</b></h2>
                <h3>Allgemeine Hinweise</h3> 
                    <p className="ml-4">Die folgenden Hinweise geben einen einfachen &Uuml;berblick dar&uuml;ber,
                ...
                <h3>Datenerfassung auf dieser Website</h3> 
                    <h4 className="ml-2">Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser Website?</h4> 
                    <p className="ml-4">Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen
                    ...
                    <h4 className="ml-2"> Wie erfassen wir Ihre Daten?</h4> 
                        <p className="ml-4"> Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es sich z.&nbsp;B. um Daten handeln, die Sie in ein
                            Kontaktformular eingeben.</p> 
                        <p className="ml-4"> Andere Daten werden automatisch oder nach Ihrer Einwilligung beim Besuch
                            ...
                            Website betreten.</p> 
                    <h4 className="ml-2">Wof&uuml;r nutzen wir Ihre Daten?</h4> 
                        <p className="ml-4"> Ein Teil der Daten wird erhoben, um eine
                    ...
                    <h4 className="ml-2">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
                        <p className="ml-4"> Sie haben jederzeit das Recht, unentgeltlich Auskunft &uuml;ber Herkunft, Empf&auml;nger und Zweck Ihrer
                            ...
                            zu.</p> 
                        <p className="ml-4"> Hierzu sowie zu weiteren Fragen zum Thema Datenschutz k&ouml;nnen Sie sich jederzeit an uns
                            wenden.</p>
                <h2><b>2. Hosting</b></h2>
                <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
                <h3>Externes Hosting</h3> 
                    <p className="ml-4"> Diese Website wird extern gehostet. Die personenbezogenen Daten, die auf dieser
                    ...
                    <p className="ml-4"> Das externe Hosting erfolgt zum Zwecke der Vertragserf&uuml;llung gegen&uuml;ber unseren potenziellen und
                    ...
                    <p className="ml-4"> Unser(e) Hoster wird bzw. werden Ihre Daten
                    ...
                    <p className="ml-4">Wir setzen folgende(n) Hoster ein:</p>
                        <p className="ml-6">Vercel Inc.<br />
                            440 N Barranca Ave #4133<br />
                            Covina, CA 91723<br />
                            privacy@vercel.com</p>
                <h2><b>3. Allgemeine Hinweise und Pflicht&shy;informationen</b></h2>
                <h3>Datenschutz</h3> 
                    <p className="ml-4"> Die Betreiber dieser Seiten nehmen den Schutz Ihrer pers&ouml;nlichen Daten sehr
                    ...
                    <p className="ml-4"> Wenn Sie diese Website benutzen, werden verschiedene personenbezogene Daten erhoben. Personenbezogene Daten sind Daten, mit denen Sie
                        ...
                        geschieht.</p> 
                    <p className="ml-4"> Wir weisen darauf hin, dass die Daten&uuml;bertragung im Internet (z.&nbsp;B. bei der
                ...
                <h3>Speicherdauer</h3> 
                    <p className="ml-4">Soweit innerhalb dieser Datenschutzerkl&auml;rung keine speziellere Speicherdauer
                ...
                <p className="ml-4"> Sofern Sie in die Datenverarbeitung eingewilligt haben, verarbeiten wir Ihre personenbezogenen Daten auf Grundlage von Art.
                ...
                <h3>Empfänger von personenbezogenen Daten</h3> 
                    <p className="ml-4">Im Rahmen unserer Gesch&auml;ftst&auml;tigkeit
                ...
                <h3>Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3> 
                    <p className="ml-4">Viele Datenverarbeitungsvorg&auml;nge sind
                ...
                <h3>Widerspruchsrecht gegen die Datenerhebung in besonderen F&auml;llen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3> 
                    <p className="ml-4">WENN DIE DATENVERARBEITUNG AUF GRUNDLAGE VON ART. 6 ABS. 1 LIT. E ODER F
                ...
                <h3>Beschwerde&shy;recht bei der zust&auml;ndigen Aufsichts&shy;beh&ouml;rde</h3> 
                    <p className="ml-4">Im Falle von Verst&ouml;&szlig;en gegen die DSGVO steht den Betroffenen ein Beschwerderecht bei einer
                ...
                <h3>Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3> 
                    <p className="ml-4">Sie haben das Recht, Daten, die wir auf Grundlage Ihrer Einwilligung oder in Erf&uuml;llung eines Vertrags automatisiert verarbeiten, an sich oder an einen Dritten in
                ...
                <h3>Auskunft, Berichtigung und L&ouml;schung</h3> 
                    <p className="ml-4">Sie haben im Rahmen der geltenden gesetzlichen
                ...
                <h3>Recht auf Einschr&auml;nkung der Verarbeitung</h3> 
                    <p className="ml-4">Sie haben das Recht, die Einschr&auml;nkung der
                    ...
                    Das Recht auf Einschr&auml;nkung der Verarbeitung besteht in folgenden F&auml;llen:</p> 
                        <ul className="ml-6"> <li>Wenn Sie die
                    ...
                    <p className="ml-4">Wenn Sie die Verarbeitung Ihrer personenbezogenen Daten eingeschr&auml;nkt haben, d&uuml;rfen diese
                    ...
                    <h3>SSL- bzw. TLS-Verschl&uuml;sselung</h3> 
                        <p className="ml-4">Diese Seite nutzt aus Sicherheitsgr&uuml;nden und zum Schutz
                ...
                <h2><b>4. Datenerfassung auf dieser Website</b></h2>
                    <h3>Server-Log-Dateien</h3> 
                    <p className="ml-4">Der Provider der Seiten erhebt und speichert automatisch Informationen in so
                    ...
                    <p className="ml-4">Eine Zusammenf&uuml;hrung dieser Daten mit anderen Datenquellen wird nicht vorgenommen.</p> 
                    <p className="ml-4">Die
